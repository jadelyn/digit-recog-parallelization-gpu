...
CUDA_DIR = /usr/local/cuda-4.2

NVCC = nvcc -I $(CUDA_DIR)/include -I $(CUDA_DIR)/NVIDIA_GPU_Computing_SDK/shared/inc -I $(CUDA_DIR)/NVIDIA_GPU_Computing_SDK/C/common/inc
...
CC = $(NVCC)  -O3
CFLAGS = --compiler-options "-std=gnu99"
...
benchmark: benchmark.o calc_dist.o utils.o test_digitrec.o oracle.o launch_gpu.o
	$(CC) -o $@ $(LDFLAGS) $+

digit_rec: digit_rec.o calc_dist.o utils.o test_digitrec.o launch_gpu.o
	$(CC) -o $@ $(LDFLAGS) $+
