...
//extern "C"
//extern float calc_min_dist(float *image, int i_width, int i_height,
//        float *temp, int t_width);

extern float* launch_gpu_computation(float *image, int i_width, int i_height,
        float *temp, int t_width);

extern float just_get_dist_gpu(float *image, int i_width, int i_height,
        float *temp, int t_width);
